...
import 'package:data_crowslector/widgets/inputs.dart';
import 'package:data_crowslector/utils/validators.dart';
import 'package:data_crowslector/widgets/progress.dart';
import 'package:data_crowslector/pages/email_verification.dart';
...
//          MyHomePage.routeAuth, (Route<dynamic> route) => false);
//    }
//
//    setState(() {
//      _isLoading = false;
...
//  }
  ...
  Widget _socialLogin(BuildContext context) {
    double btnWidth = MediaQuery.of(context).size.width * 0.8;
...
//                }),
            _socialButton(
                "Google", google, googleDark, btnWidth, MdiIcons.google,
                    () async {
  ...
  Form _signInForm(BuildContext context, double verticalPadding) {
    return Form(
      ...
      child: Column(
        children: <Widget>[
          customTextInput("Correo Electrónico", MdiIcons.email,
            ...
            child: Row(
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Text(
                    "Monitoriza tu actividad física minuto a minuto",
                ...
                Image.asset('assets/images/EmoviLogo.png'),
